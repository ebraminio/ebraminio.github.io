...
// https://fa.wikipedia.org/w/index.php?title=مدیاویکی:Gadget-Extra-Editbuttons-dictionary.js&oldid=35566771
var persianToolsDictionary = (function () {
    ...
    dictionary.wordsWithA = 'ورامدن|هرزاب|هراینه|هجوامیز|نوش‌اذر|نواوری|نواموز|نهراب|میراخور|میراب|می‌اید|می‌اورند' +
    ...
    // TODO: This should be the only exposure
    dictionary.dictation = dictation;
